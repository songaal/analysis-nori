...
public class SimpleAnalysisTest extends LuceneTestCase {
    ...
    private static final String TEXT_STR = "아름다운ABC이땅에123금수강산에a12단군할아버지가터잡으시고홍익인간뜻으로나라세우니대대손손훌륭한인물도많아고구려세운동명왕백제온조왕알에서나온혁거세";
    ...
    public void simpleTokenizerTest() throws Exception {
        ...
        try {
            ...
            Reader input = new StringReader(TEXT_STR);
